...
<div class="container pb-6 pt-6">
	<?php
        ...
        if($check_producto->rowCount()>0){
			...
			$estado_actual = ($check_estado->rowCount() > 0) ? $check_estado->fetch()['estado'] : '';
	?>
	...
	<form action="./php/producto_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Marca</label>
				  	<input class="input" type="text" name="producto_marca" pattern="[a-zA-Z0-9]{1,25}" maxlength="25" required value="<?php echo $datos['producto_marca']; ?>" >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Modelo</label>
				  	<input class="input" type="text" name="producto_modelo" pattern="[a-zA-Z0-9\s-]{1,25}" maxlength="25" required value="<?php echo $datos['producto_modelo']; ?>" >
				</div>
		  	</div>
		  	<div class="column">
			...
			<div class="column">
				<label>Estado del servicio</label><br>
					<div class="select is-rounded" >
            			...
            			<option value="Terminado" <?php echo ($estado_actual == 'Terminado') ? 'selected' : ''; ?>>Terminado</option>
						</select>
					</div>
			</div>
		</div>
