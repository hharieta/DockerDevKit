<?php
    ...
    if($codigo=="" || $nombre=="" || $marca=="" || $modelo=="" || $categoria==""){
        echo '
    ...
    $guardar_producto=$guardar_producto->prepare("INSERT INTO producto(producto_codigo,producto_nombre,producto_marca,producto_modelo,producto_foto,categoria_id,usuario_id) VALUES(:codigo,:nombre,:marca,:modelo,:foto,:categoria,:usuario)");
